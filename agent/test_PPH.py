...
def main():
    ...
    tasker.post_task("PPH_OneLevel_3_2_clean", pipeline_override).wait().get()
    ...
    #     # #
    #     # # # 前往怪面前
    #     pipeline_override["AF_Move_W"]["action"]["param"]["duration"] = 5000
    #     tasker.post_task("AF_Move_W", pipeline_override).wait().get()
    #
    #     # # 简易战斗策略
    #     # # tasker.post_task("AF_Action_AutoFightSimple", pipeline_override).wait().get()
    #     # # tasker.post_task("AF_AutoFightSimple", pipeline_override).wait().get()
    #
    #     # # yolo目标分类战斗策略
    #     # while True:
