...
def main():
    ...
    # pipeline_override["AF_AutoFightClsTest"]["recognition"]["param"][
    #     "custom_recognition_param"] = {"model": "best2.onnx", "repeat_time": 3}
    # tasker.post_task("AF_AutoFightClsTest", pipeline_override).wait().get()

    # pipeline_override["AF_AutoFightCls"]["recognition"]["param"][
    #     "custom_recognition_param"] = {"model": "best2.onnx", "repeat_time": 3}
    # tasker.post_task("AF_AutoFightCls", pipeline_override).wait().get()

    a = tasker.post_task("AF_AutoFightClsTest", pipeline_override).wait().get()
    print(a)
    ...
    # # 血条验证
    # while True:
    #     tasker.post_task("血条验证", pipeline_override).wait().get()
    #     print(time.time())
    ...
    #     "custom_recognition_param"] = {"target_instance": "小心鸽子", "repeat_time": 3}
    ...
    # controller.set_mouse_lock_follow = True
    # controller.post_key_down(key_codes["lalt"])
    # controller.post_touch_move(940,320)
    # controller.post_swipe(640, 320, 740,320,duration=1000,
    #     contact = 0,
    #     pressure = 1)
