...
def main():
    ...
    #         "expected": "按下",
    #         "action": "custom",
    #         "custom_action": "UF_ActionMoveScreen",
    #         # "custom_action_param": {"target_box": [50, 50, 52, 2]}
    #     },
    # })
    ...
    # tasker.post_task("MyCustomEntry", pipeline_override).wait().get()
    # tasker.post_task("AF_FindBox_3_2_clean", pipeline_override).wait().get()
